        ...
        <div className=' bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    <img  src={assets.sammyHome} alt="logo" className='mb-4  md:h-9 w-8 h-auto scale-300 origin-left ' />
                    <p className='text-sm'>
                ...
                <div>
                    <p className='font-nunito text-lg text-gray-800'>COMPANY</p>
                ...
                <div>
                    <p className=' font-nunito text-lg text-gray-800'>SUPPORT</p>
                    <ul className='mt-3 flex flex-col gap-2 text-sm'>
                ...
                <div className='max-w-80'>
                    <p className=' font-nunito text-lg text-gray-800'>STAY UPDATED</p>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} Sammy Homes. All rights reserved.</p>
