...
const Listroom = () => {
  ...
  return (
    <div className='pt-2 pb-5' >
       <Title align='left' font='nunito' title="Room listings" subTitle='View,edit, or manage all listed rooms. keep information up tp date to provide the best experience for user'/>
      ...
      {rooms.map((item,index)=>{
        return <tr key={index}>
           ...
           <td className="py-3 px-4 border-t text-sm text-red-500 text-center">
  <label className="relative inline-flex items-center cursor-pointer text-gray-900 gap-3">
    <input
      type="checkbox"
      className="sr-only peer"
      checked={item.isAvailable}
      onChange={() => {/* handle toggle here */}}
    />
