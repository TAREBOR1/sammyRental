...
const Login = () => {
  ...
  <div className="bg-white  text-gray-500 max-w-96 p-5 text-left text-sm rounded-xl shadow-[0px_0px_10px_0px] shadow-black/10">
      ...
      <form>
        ...
        <button type="submit" className="w-full mb-3 bg-[#49B9FF] py-2.5 rounded-full text-white">
          Log in
        </button>
      </form>
      <p className="text-center mt-4">
        Don’t have an account? <a href="#" className="text-blue-500 underline">Signup</a>
      </p>
